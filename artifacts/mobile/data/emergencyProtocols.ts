...
export const emergencyProtocols: EmergencyProtocol[] = [
  ...
  },
  {
    ...
    urgency: "critical",
    color: "#EF4444",
    description: "Occlusion of pulmonary arteries by thrombus. Massive PE causes haemodynamic compromise and is immediately life-threatening.",
    steps: [
      { step: 1, title: "Recognize PE — Clinical Suspicion", details: "Sudden dyspnea, pleuritic chest pain, hemoptysis, tachycardia, hypoxia. Risk factors: DVT, immobility, surgery, malignancy, pregnancy. Wells score ≥5 = high probability.", urgent: true },
      { step: 2, title: "Resuscitation if Haemodynamically Unstable", details: "Massive PE: SBP <90 mmHg or drop >40 mmHg for >15 min. Start IV fluids (cautious — RV overload), high-flow O2. Call for senior help immediately.", urgent: true, drugs: ["O2 15 L/min via NRB mask"] },
      { step: 3, title: "Immediate Investigations", details: "ABG, ECG (S1Q3T3, sinus tachycardia, RBBB), CXR (Hampton's hump, Westermark sign), troponin, BNP, D-dimer (only if low/intermediate probability)." },
      { step: 4, title: "CT Pulmonary Angiography (CTPA)", details: "Gold standard for diagnosis. Do immediately if haemodynamically stable. Echo if unstable (RV strain = high likelihood).", urgent: true },
      { step: 5, title: "Anticoagulation — Start IMMEDIATELY", details: "Low molecular weight heparin (LMWH) or UFH. Start before CTPA result if clinical probability HIGH. Do NOT wait for imaging.", drugs: ["Enoxaparin 1.5 mg/kg SC OD (therapeutic)", "UFH: 80 U/kg bolus then 18 U/kg/h infusion"], urgent: true },
      { step: 6, title: "Systemic Thrombolysis (Massive PE)", details: "Alteplase 100 mg IV over 2 hours. Indicated for massive PE with haemodynamic compromise and no absolute contraindications. Contraindicated: prior intracranial bleed, recent stroke, active bleeding.", drugs: ["Alteplase 100 mg IV over 2h"] },
      { step: 7, title: "Surgical Embolectomy / Catheter-Directed Thrombolysis", details: "If thrombolysis contraindicated or failed. Refer to cardiothoracic surgery." },
      { step: 8, title: "Long-term Anticoagulation", details: "Minimum 3 months for provoked PE. Extended for unprovoked (6–12 months or indefinite). Warfarin (target INR 2–3) or DOAC (rivaroxaban, apixaban).", drugs: ["Rivaroxaban 15 mg BD x21 days, then 20 mg OD", "Apixaban 10 mg BD x7 days, then 5 mg BD"] },
    ],
    keyDrugs: [
      { name: "Enoxaparin (LMWH)", dose: "1.5 mg/kg SC OD (therapeutic)", route: "SC" },
      { name: "Alteplase", dose: "100 mg IV over 2h", route: "IV (massive PE)" },
      { name: "Rivaroxaban", dose: "15 mg BD x21d, then 20 mg OD", route: "PO" },
    ],
    keyPoints: [
      "D-dimer only useful to RULE OUT PE in low/intermediate probability (not to diagnose)",
      "CTPA is gold standard — do not delay anticoagulation waiting for results",
      "S1Q3T3 on ECG — classic but rare; sinus tachycardia is most common ECG finding",
      "Massive PE: alteplase if haemodynamically compromised",
      "Unprovoked PE: investigate for underlying malignancy",
    ],
  },
  {
    ...
    urgency: "critical",
    color: "#EF4444",
    description: "Severe hypertension (usually >180/120 mmHg) WITH acute end-organ damage (brain, heart, kidneys, eyes). Distinguish from hypertensive urgency (no organ damage).",
    steps: [
      { step: 1, title: "Confirm Hypertensive Emergency", details: "BP >180/120 mmHg PLUS: Hypertensive encephalopathy, intracranial hemorrhage, aortic dissection, acute heart failure, STEMI, eclampsia, AKI. Urgency = same BP without organ damage.", urgent: true },
      { step: 2, title: "Immediate Assessment", details: "History: onset, medications, compliance. Exam: fundoscopy (papilloedema, flame hemorrhages), neuro assessment, auscultate for aortic regurgitation, check renal function." },
      { step: 3, title: "Target Organ Investigation", details: "ECG, CXR, UEC, creatinine, urinalysis, CT brain (if neuro symptoms), echo if aortic dissection suspected." },
      { step: 4, title: "IV Antihypertensive — ICU Setting", details: "Aim: reduce MAP by 10-15% in first hour, by 25% in first 24h (NOT to normal — risk of ischemia). Choice depends on organ involved.", drugs: ["Labetalol 20 mg IV bolus, then infusion", "Nicardipine 5-15 mg/h IV infusion", "Sodium nitroprusside 0.25-10 mcg/kg/min IV"], urgent: true },
      { step: 5, title: "Special Situations", details: "Aortic dissection: target SBP <120, HR <60 — labetalol. Eclampsia: IV magnesium sulphate + labetalol/hydralazine. Ischaemic stroke: treat only if BP >220/120 or thrombolysis planned.", drugs: ["MgSO4 4g IV loading (eclampsia)", "Hydralazine 5-10 mg IV (eclampsia)"] },
      { step: 6, title: "Transition to Oral Therapy", details: "Once BP controlled, convert to oral agents. Ensure compliance. Identify reversible cause (renal artery stenosis, phaeochromocytoma, primary hyperaldosteronism)." },
    ],
    keyDrugs: [
      { name: "Labetalol", dose: "20 mg IV bolus, then 1–2 mg/min infusion", route: "IV" },
      { name: "Nicardipine", dose: "5–15 mg/h", route: "IV infusion" },
      { name: "Sodium Nitroprusside", dose: "0.25–10 mcg/kg/min", route: "IV infusion (cyanide toxicity risk)" },
    ],
    keyPoints: [
      "Do NOT normalize BP rapidly — risk of end-organ ischemia from autoregulation failure",
      "Target MAP reduction: 10-15% in 1h, 25% in 24h",
      "Aortic dissection: reduce BP and HR urgently — labetalol of choice",
      "Hypertensive urgency: oral therapy, no ICU required",
  ...
  },
  {
    ...
    urgency: "critical",
    color: "#EF4444",
    description: "Acute-onset breathlessness due to fluid accumulation in the alveoli, most commonly from left ventricular failure. Immediate treatment is life-saving.",
    steps: [
      { step: 1, title: "Recognize — SOAP-M Mnemonic", details: "Sudden onset breathlessness, Orthopnoea, crepitations, pink frothy sputum. Exam: bilateral basal crackles, 3rd heart sound, cold clammy peripheries, JVP raised.", urgent: true },
      { step: 2, title: "Positioning + High-Flow O2", details: "Sit patient upright (legs dependent — reduces preload). O2 via NRB mask, target SpO2 >94%. Consider CPAP/BiPAP early.", drugs: ["O2 via NRB mask — target SpO2 94-98%"], urgent: true },
      { step: 3, title: "IV Furosemide", details: "Furosemide 40-80 mg IV stat (loop diuretic). Causes venodilation before diuresis. If on oral furosemide, double the usual dose IV.", drugs: ["Furosemide 40–80 mg IV stat"], urgent: true },
      { step: 4, title: "IV Nitrates (if SBP >100)", details: "GTN infusion 1-10 mg/h IV, titrate to BP. Causes venodilation reducing preload. Do NOT use if SBP <90 mmHg or severe aortic stenosis.", drugs: ["GTN IV 1–10 mg/h (titrate)", "OR GTN sublingual 0.4 mg spray"] },
      { step: 5, title: "Non-Invasive Ventilation (CPAP)", details: "CPAP 5-10 cmH2O if SpO2 remains low despite O2. Significantly reduces need for intubation and improves mortality." },
      { step: 6, title: "Treat Underlying Cause", details: "ACS (STEMI/NSTEMI), arrhythmia (AF — rate control), hypertension, valvular disease, fluid overload. Treat precipitant aggressively." },
      { step: 7, title: "Morphine (cautious use)", details: "Low-dose IV morphine 2-4 mg may reduce anxiety and preload. Use with caution — may cause respiratory depression. Controversial — avoid in COPD.", drugs: ["Morphine 2–4 mg IV (cautious, with antiemetic)"] },
    ],
    keyDrugs: [
      { name: "Furosemide", dose: "40–80 mg IV stat", route: "IV" },
      { name: "GTN (Glyceryl trinitrate)", dose: "1–10 mg/h", route: "IV infusion (if SBP >100)" },
      { name: "Furosemide maintenance", dose: "Ongoing IV/PO depending on response", route: "IV/PO" },
    ],
    keyPoints: [
      "Sit patient upright first — simple measure with immediate benefit",
      "Furosemide IV causes venodilation BEFORE diuresis",
      "CPAP reduces intubation rates — start early",
      "Avoid nitrates if SBP <90 mmHg",
      "Identify and aggressively treat precipitant (ACS, arrhythmia)",
    ],
  },
  {
    id: "upper-gi-bleed",
    ...
    urgency: "critical",
    color: "#EF4444",
    description: "Bleeding proximal to the ligament of Treitz. Presents as haematemesis and/or melaena. Most common cause: peptic ulcer disease.",
    steps: [
      { step: 1, title: "ABC — Resuscitation First", details: "Airway: protect if haematemesis (aspiration risk). Two large-bore IV cannulae. Monitor: BP, HR, SpO2, urine output. Fluid resuscitation.", urgent: true },
      { step: 2, title: "Risk Stratify — Rockall Score", details: "Pre-endoscopy Rockall: Age, shock, comorbidities. Post-endoscopy: diagnosis, stigmata. Score >8 = high risk. Glasgow-Blatchford score for pre-endoscopy risk." },
      { step: 3, title: "Blood Transfusion", details: "Transfuse if Hb <7 g/dL (or <8 in cardiac patients). Target Hb 7-9 g/dL. Fresh Frozen Plasma if INR >1.5. Platelets if <50,000.", drugs: ["Packed RBCs (target Hb 7-9 g/dL)", "FFP if INR >1.5"] },
      { step: 4, title: "IV Proton Pump Inhibitor", details: "Omeprazole 80 mg IV bolus, then 8 mg/h infusion for 72 hours. Reduces re-bleeding and mortality in peptic ulcer bleeding.", drugs: ["Omeprazole 80 mg IV bolus, then 8 mg/h x72h"], urgent: true },
      { step: 5, title: "Urgent Endoscopy (OGD)", details: "Within 24 hours for most; <12 hours if high-risk features (ongoing bleeding, shock). Allows diagnosis and endoscopic haemostasis.", urgent: true },
      { step: 6, title: "Variceal Bleeding", details: "Terlipressin 2 mg IV (reduces portal pressure). Prophylactic antibiotics (ciprofloxacin/ceftriaxone). Endoscopic band ligation. Sengstaken tube if uncontrolled.", drugs: ["Terlipressin 2 mg IV q4h", "Ceftriaxone 1g IV OD"] },
    ],
    keyDrugs: [
      { name: "Omeprazole", dose: "80 mg IV bolus, then 8 mg/h x72h", route: "IV" },
      { name: "Terlipressin", dose: "2 mg IV q4-6h (variceal)", route: "IV" },
      { name: "Ceftriaxone", dose: "1g OD (variceal prophylaxis)", route: "IV" },
    ],
    keyPoints: [
      "Resuscitate before endoscopy",
      "Omeprazole infusion for peptic ulcer bleeding — reduces re-bleeding",
      "Terlipressin + antibiotics for variceal bleeding — reduces mortality",
      "Restrictive transfusion strategy (target Hb 7-9) — better outcomes",
  ...
  },
  {
    ...
    urgency: "high",
    color: "#F97316",
    description: "Abrupt decline in renal function. KDIGO criteria: creatinine rise ≥26 µmol/L in 48h or ≥1.5x baseline in 7 days, or urine output <0.5 mL/kg/h for 6h.",
    steps: [
      { step: 1, title: "Identify AKI Stage", details: "Stage 1: Cr x1.5–1.9 baseline or rise ≥26 µmol/L. Stage 2: Cr x2–2.9. Stage 3: Cr x3+ or >353 µmol/L or dialysis. Urine output criteria also apply.", urgent: true },
      { step: 2, title: "Identify Cause — Pre/Intra/Post-Renal", details: "Pre-renal (60%): dehydration, sepsis, cardiac failure — BUN:Cr >20:1. Intrinsic (35%): ATN, glomerulonephritis, drugs, contrast. Post-renal (5%): obstruction." },
      { step: 3, title: "Stop Nephrotoxins", details: "HOLD: NSAIDs, ACEi/ARB, gentamicin, metformin, contrast agents. Review all medications and adjust doses for GFR." },
      { step: 4, title: "Fluid Management", details: "Pre-renal: IV crystalloid resuscitation 250-500 mL boluses. Reassess after each. Avoid fluid overload. Target urine output >0.5 mL/kg/h.", drugs: ["0.9% NaCl or Hartmann's — 250-500 mL boluses"], urgent: true },
      { step: 5, title: "Treat Hyperkalaemia (K+ >6.5 or ECG changes)", details: "ABCDE approach: A=Atrial stabilization (calcium gluconate), B=Beta2 agonist, C=Correct acidosis, D=Diuresis, E=Excretion (dialysis).", drugs: ["Calcium gluconate 10% 10 mL IV (membrane protection)", "Insulin 10U + Dextrose 50 mL 50% (K+ shift)", "Salbutamol 10-20 mg nebulized"], urgent: true },
      { step: 6, title: "Identify and Treat Obstruction", details: "Bladder scan: if urinary retention, catheterize immediately. Hydronephrosis on USS: urology consult for stenting." },
      { step: 7, title: "Renal Replacement Therapy (Dialysis) Indications", details: "AEIOU: Acidosis (pH <7.1), Electrolytes (K+ refractory), Intoxication, Overload (fluid refractory), Uraemia (encephalopathy, pericarditis)." },
    ],
    keyDrugs: [
      { name: "Calcium Gluconate 10%", dose: "10 mL IV over 5-10 min", route: "IV (ECG protection in hyperkalaemia)" },
      { name: "Insulin + Dextrose", dose: "10U insulin + 50 mL 50% dextrose", route: "IV" },
      { name: "Crystalloid", dose: "250–500 mL boluses", route: "IV" },
    ],
    keyPoints: [
      "Always check for urinary obstruction — simple catheterization can resolve post-renal AKI",
      "Stop nephrotoxins immediately: NSAIDs, ACEi, aminoglycosides",
      "Hyperkalaemia is the most immediately life-threatening complication",
      "Dialysis indications: AEIOU mnemonic",
      "Contrast nephropathy: pre-hydrate with 0.9% NaCl before contrast procedures",
    ],
  },
];
